    ...
    <div class="container text-center">
        ...
        <table class="mx-auto">
            ...
            @foreach($mains as $main)
                <td class="px-5">
                    <a href="/item/{{$main->id}}">      
                        <img class="menuImage" src="{{ \Config::get('app.mediaPATH') }}{{$main->menu_pic}}" alt="no image"> 
        ...
        <table class="mx-auto">
            ...
            @foreach($sides as $side)
                <td class="px-5">
                    <a href="item/{{$side->id}}">      
                        <img class="menuImage" src="{{ \Config::get('app.mediaPATH') }}{{$side->menu_pic}}" alt="no image"> 
            ...
            @foreach($deserts as $desert)
                <td class="px-5">
                    <a href="item/{{$desert->id}}">      
                        <img class="menuImage" src="{{ \Config::get('app.mediaPATH') }}{{$desert->menu_pic}}" alt="no image"> 
            ...
            @foreach($drinks as $drink)
                <td class="px-5">
                    <a href="item/{{$drink->id}}">      
                        <img class="menuImage" src="{{ \Config::get('app.mediaPATH') }}{{$drink->menu_pic}}" alt="no image"> 
